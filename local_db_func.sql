...
/*module: 用戶
  field: 語言名稱
 */
CREATE OR REPLACE FUNCTION public.V0301_USLSNAME(F0301) RETURNS 
    VARCHAR AS $$
DECLARE
	r VARCHAR;
BEGIN
...
/*module: 證書
  field: 語言名稱
 */
CREATE OR REPLACE FUNCTION public.V0331_CRLSNAME(F0331) RETURNS 
    VARCHAR AS $$
DECLARE
	r VARCHAR;
BEGIN
...
/*module: 證書
  field: 學術名
 */
CREATE OR REPLACE FUNCTION public.V0331_CRLSLOC(F0331) RETURNS 
    VARCHAR AS $$
DECLARE
	r VARCHAR;
BEGIN
...
/*module: 文章
  field: 摘要
 */
CREATE OR REPLACE FUNCTION public.V1110_ATBRF(F1110) RETURNS 
    VARCHAR AS $$
DECLARE
	r VARCHAR;
 	l INT;
...
/*module: 文章
  field: A類
 */
CREATE OR REPLACE FUNCTION public.V1110_ATCSA(F1110) RETURNS 
    SMALLINT AS $$
DECLARE
	r INT;
BEGIN
...
/*module: 文章
  field: B類
 */
CREATE OR REPLACE FUNCTION public.V1110_ATCSB(F1110) RETURNS 
    SMALLINT AS $$
DECLARE
	r INT;
BEGIN
...
/*module: 文章
  field: C類
 */
CREATE OR REPLACE FUNCTION public.V1110_ATCSC(F1110) RETURNS 
    SMALLINT AS $$
DECLARE
	r INT;
BEGIN
...
/*module: 文章
  field: D類
 */
CREATE OR REPLACE FUNCTION public.V1110_ATCSD(F1110) RETURNS 
    SMALLINT AS $$
DECLARE
	r INT;
BEGIN
...
/*module: 文章
  field: E類
 */
CREATE OR REPLACE FUNCTION public.V1110_ATCSE(F1110) RETURNS 
    SMALLINT AS $$
DECLARE
	r INT;
BEGIN
...
/*module: 文章
  field: F類
 */
CREATE OR REPLACE FUNCTION public.V1110_ATCSF(F1110) RETURNS 
    SMALLINT AS $$
DECLARE
	r INT;
BEGIN
...
/*module: 文句
  field: 類
 */
CREATE OR REPLACE FUNCTION public.V1120_ASCS(F1120) RETURNS 
    VARCHAR AS $$
DECLARE
	r VARCHAR;
	seg_all_cnt INT;
